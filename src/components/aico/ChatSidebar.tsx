    ...
    <div className="w-80 border-r border-gray-200 dark:border-dark-700 bg-white dark:bg-dark-800 flex flex-col">
      ...
      <div className="flex-1 overflow-y-auto">
        ...
        <div className="space-y-1">
          {recentChats.map((chat) => (
            <div
              key={chat.id}
              className="flex items-center px-4 py-3 hover:bg-gray-50 dark:hover:bg-dark-700 group cursor-pointer"
            >
              ...
              <div 
                className="p-1 opacity-0 group-hover:opacity-100 hover:bg-gray-100 dark:hover:bg-dark-600 rounded transition-opacity cursor-pointer"
                onClick={(e) => {
                  e.stopPropagation();
                  // Handle delete
                }}
      ...
      <div className="p-4 border-t border-gray-200 dark:border-dark-700">
        <div 
          ...
          className="flex items-center space-x-2 text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white w-full px-3 py-2 rounded-lg hover:bg-gray-50 dark:hover:bg-dark-700 cursor-pointer"
        >
